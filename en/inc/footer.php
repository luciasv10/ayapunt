                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 sm-padding">
                        <div class="footer_widget">
                            ...
                            <!-- <p>Ayapunt, S.A. is a business dedicated to make school uniforms, not only those used in schools but also those used in sports.</p> -->
			...
			<div class="container">
                <div class="row">
                    <div class="col-md-6 xs-padding">
                        <div class="copyright">Copyrights &copy; <script type="text/javascript"> document.write(new Date().getFullYear())</script>  All rights reserved.</div>
                    </div>
                    <div class="col-md-6 xs-padding">
